...
--important variables used in the code
	...
	--controls how many seconds we will wait between saves before saving again
...
--functions of the data store

	--updates the leaderboard in game
	...
	--when you create a ModuleScript and call it from another script, you can assign it to a variable
